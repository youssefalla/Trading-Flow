      ...
      <main className="flex-1 p-6 md:p-8 overflow-y-auto">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl overflow-hidden tf-card-bg col-span-2" style={{ boxShadow: 'inset 0 0 60px rgba(201,168,76,.07), 0 0 0 1px rgba(201,168,76,.18)' }}>
            ...
            <div className="col-span-1">
              {aiResult ? (
                <div className="rounded-2xl p-5 tf-card-bg h-full flex flex-col" style={{ boxShadow: 'inset 0 0 60px rgba(201,168,76,.07), 0 0 0 1px rgba(201,168,76,.18)' }}>
                ...
                <div className="rounded-2xl p-6 tf-card-bg h-full flex flex-col items-center justify-center text-center" style={{ boxShadow: 'inset 0 0 60px rgba(201,168,76,.07), 0 0 0 1px rgba(201,168,76,.18)' }}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-2xl p-5 tf-card-bg" style={{ boxShadow: 'inset 0 0 60px rgba(201,168,76,.07), 0 0 0 1px rgba(201,168,76,.18)' }}>
